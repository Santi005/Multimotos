...
const { getSale, postSale, desactivateSale, activateSale, searchSale, getDocument, updateSaleToSend, updateSaleToDelivered, updateSaleToPending } = require('../controllers/SaleController');
